...
class Client {
	constructor(logServer) {
		const urlInfo = url.parse(logServer || 'timtam://127.0.0.1:7001');
		const options = {
...
module.exports = new Client(config.log);

// const options = {};
// if (config.log) {
// 	const urlInfo = url.parse(config.log);
// 	options.port = parseInt(urlInfo.port);
// 	options.host = urlInfo.hostname;
// }
// const clinet = new Client(options);
